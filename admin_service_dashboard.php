...
<div class="alert alert-success">
  ...
  <button class="tablinks" onclick="openCity(event, 'Tokyo')">Tokyo</button> -->
        ...
        <div class="tabcontent" id="bookdetails" style="<?php if(!empty($_REQUEST['view'])){ echo "display:block";$id=$_REQUEST['view'];} else {echo "display:none";}?> ">
        <div>
            <h2 style="text-align: center;">Book Details</h2>
                    ...
                    ?>
                    <img src="images/<?php echo $bookpic?>" width='150px' height='150px' style='border:1px solid #333333; float:left;margin-left:80px;margin-top:20px'>
              <div class="right">
                    
               <p><b><u>Book Name:</u> &nbsp&nbsp</b><?php echo $bookname?></p>
               <p><b><u>Book Detail:</u> &nbsp&nbsp</b><?php echo $bookdetail?></p>
               <p><b><u>Book Author:</u> &nbsp&nbsp</b><?php echo $bookauthor?></p>
               <p><b><u>Book Publisher:</u>&nbsp&nbsp </b><?php echo $bookpub?></p>
               <p><b><u>Branch:</u>&nbsp&nbsp </b><?php echo $branch?></p>
               <p><b><u>Book Price:</u> &nbsp&nbsp</b><?php echo $bookprice?></p>
               <p><b><u>Book Available:</u> &nbsp&nbsp</b><?php echo $bookava?></p>
               <p><b><u>Book On Ren:</u> &nbsp&nbsp</b><?php echo $bookrent?></p>
